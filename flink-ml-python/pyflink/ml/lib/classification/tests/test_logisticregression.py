...
class OnlineLogisticRegressionTest(PyFlinkMLTestCase):
    ...
    def test_param(self):
        ...
        self.assertEqual(0.25, online_logistic_regression.reg)
        self.assertEqual(0.25, online_logistic_regression.elastic_net)
        self.assertEqual(0.25, online_logistic_regression.alpha)
        self.assertEqual(0.25, online_logistic_regression.beta)
