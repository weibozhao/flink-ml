...
public class EvalBinaryTest {
    ...
    public void testEval() throws Exception {
        EvalBinaryClass eval =
                new EvalBinaryClass().setLabelCol("label").setRawPredictionCol("raw");
    ...
    public void test() throws Exception {
        ...
        DataStream<Object> output =
                input.keyBy(
                        ...
                        .apply(
                                new WindowFunction<Tuple2<Long, Long>, Object, Long, TimeWindow>() {
                                    @Override
                                    public void apply(
                                            Long aLong,
                                            TimeWindow window,
