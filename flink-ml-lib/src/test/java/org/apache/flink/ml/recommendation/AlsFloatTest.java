...
public class AlsFloatTest extends AbstractTestBase {
    ...
    private void verifyPredictionResult(Table output, String predictionCol, double expectedData)
        ...
        for (Row predictionRow : predictResult) {
            ...
            assertEquals(prediction, expectedData, FLOAT_TOLERANCE);
            // System.out.println(prediction + " " + expectedData);
        }
    }
    ...
    public void testParam() {
        ...
        assertEquals(1.0, als.getAlpha(), FLOAT_TOLERANCE);
        assertEquals(0.1, als.getRegParam(), FLOAT_TOLERANCE);
        ...
        assertEquals(0.001, als.getAlpha(), FLOAT_TOLERANCE);
        assertEquals(0.5, als.getRegParam(), FLOAT_TOLERANCE);
