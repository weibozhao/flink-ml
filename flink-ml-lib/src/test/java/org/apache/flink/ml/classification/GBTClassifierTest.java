...
import org.apache.flink.ml.classification.gbtclassifier.PaiGBTClassifierModelServable;
...
public class GBTClassifierTest extends AbstractTestBase {
    ...
    public void testFitAndPredictWithNoCategoricalCols() throws Exception {
        ...
        List<Row> outputRowsUsingNoCategoricalCols =
                Arrays.asList(
                        Row.of(
                                0.0,
                                Vectors.dense(2.34563907006811, -2.34563907006811),
                                Vectors.dense(0.9125869728543822, 0.0874130271456178)),
                        Row.of(
                                1.0,
                                Vectors.dense(-2.3303467465269785, 2.3303467465269785),
                                Vectors.dense(0.0886406478666607, 0.9113593521333393)),
                        Row.of(
                                1.0,
                                Vectors.dense(-2.6627806586536007, 2.6627806586536007),
                                Vectors.dense(0.06520563648648892, 0.9347943635135111)),
                        Row.of(
                                0.0,
                                Vectors.dense(2.2219234863111987, -2.2219234863111987),
                                Vectors.dense(0.9022010445561748, 0.09779895544382528)),
                        Row.of(
                                1.0,
                                Vectors.dense(-2.4261826518456586, 2.4261826518456586),
                                Vectors.dense(0.08119780449041314, 0.9188021955095869)),
                        Row.of(
                                0.0,
                                Vectors.dense(2.6577392865785714, -2.6577392865785714),
                                Vectors.dense(0.9344863980226659, 0.06551360197733418)),
                        Row.of(
                                1.0,
                                Vectors.dense(-2.6641132494818254, 2.6641132494818254),
                                Vectors.dense(0.0651244569774293, 0.9348755430225707)),
                        Row.of(
                                0.0,
                                Vectors.dense(2.6577392865785714, -2.6577392865785714),
                                Vectors.dense(0.9344863980226659, 0.06551360197733418)),
                        ...
                        Row.of(
                                1.0,
                                Vectors.dense(-2.4318453555603523, 2.4318453555603523),
                                Vectors.dense(0.08077634070928352, 0.9192236592907165)));
    ...
    public void testGetModelData() throws Exception {
        ...
        Assert.assertArrayEquals(
                gbtc.getFeaturesCols(), featureImportanceMap.keySet().toArray(new String[0]));
    }
    ...
    @Test
    public void testSetModelDataToPaiServable() throws Exception {
        GBTClassifier gbtc =
                new GBTClassifier()
                        .setFeaturesCols("f0", "f1", "f2")
                        .setCategoricalCols("f2")
        ...
        PaiGBTClassifierModelServable servable = new PaiGBTClassifierModelServable();
        servable.setModelData(new ByteArrayInputStream(serializedModelData));
        Map<String, Object> designerParams = new HashMap<>();
        designerParams.put("predictionCol", "pred");
        designerParams.put("predictionDetailCol", "pred_detail");
        servable.setDesignerParams(designerParams);
