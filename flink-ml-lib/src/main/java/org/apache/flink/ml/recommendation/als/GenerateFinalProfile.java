...
/** Comments. */
public class GenerateFinalProfile
        implements MapFunction<Tuple5<Long, Long, Long, Integer, Integer>, Ratings> {

    @Override
    public Ratings map(Tuple5<Long, Long, Long, Integer, Integer> value) {
        Ratings profile = new Ratings();
        profile.neighbors = new long[] {value.f0, value.f1, value.f2, value.f3, value.f4};
        profile.scores = null;
        return profile;
    }
}
