 ...
 */
public class FastDistanceSparseData extends BaseFastDistanceData {
    ...
    public FastDistanceSparseData(
            List<Integer>[] indices, List<Double>[] values, int vectorNum, Row[] rows) {
        super(rows);
        ...
        Preconditions.checkArgument(
                indices.length == values.length, "Index size not equal to value size!");
    ...
    public FastDistanceSparseData(
            HashMap<Integer, Tuple2<List<Integer>, List<Double>>> indexHashMap, int vectorNum) {
    ...
    public FastDistanceSparseData(
        ...
        for (int i = 0; i < this.indices.length; i++) {
            ...
            if (t != null) {
                Preconditions.checkArgument(
                        t.f0 != null && t.f1 != null && t.f0.size() == t.f1.size(),
                        "Index size not equal to value size!");
    ...
    /**
     * deserialization of FastDistanceSparseData.
     *
