...
/** SGD optimizer. */
public class SGD extends BaseFmOptimizer {
    private final int modelOffset;
    private final double learnRate;

    public SGD(int[] dim, double learnRate, double std) {
        super(dim, std);
