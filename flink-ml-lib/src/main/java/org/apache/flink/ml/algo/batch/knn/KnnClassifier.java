...
/**
 * KNN classifier is to classify unlabeled observations by assigning them to the class of the most similar labeled
 * examples.
 */
public class KnnClassifier
	...
	public KnnClassificationModel fit(Table... inputs) {
		...
		KnnClassificationModel
			knnClassificationModel = new KnnClassificationModel(params);
