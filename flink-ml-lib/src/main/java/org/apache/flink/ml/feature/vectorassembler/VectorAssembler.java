            ...
            try {
                ...
                switch (handleInvalid) {
                    ...
                    case VectorAssemblerParams.KEEP_INVALID:
                        /*
                         * If KEEP_INVALID is set, all input row values will be reserved and a null
                         * result may be appended. For null value maybe exists in output column, we need
                         * fill missing values before using it or filter these invalid rows.
                         */
