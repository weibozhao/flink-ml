 ...
 */
public class StageKMeans implements Estimator<StageKMeans, KMeansModel>, KMeansParams<StageKMeans> {
    ...
    public static StageKMeans load(StreamTableEnvironment tEnv, String path) throws IOException {
