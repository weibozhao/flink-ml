 ...
 */
public final class PullComponent implements PsIterationComponent {
    public final Supplier<SharedLongArray> keys;
    public final Supplier<SharedNumericalArray> values;
    public Aggregator<double[], double[]> aggregator;
    public Aggregator<float[], float[]> floatAggregator;

    public PullComponent(
    ...
    public PullComponent(
        ...
        if (obj instanceof SharedDoubleArray) {
            this.aggregator = (Aggregator<double[], double[]>) aggregator;
        } else if (obj instanceof SharedFloatArray) {
            this.floatAggregator = (Aggregator<float[], float[]>) aggregator;
        }
    }
