...
/**
 * A PaiModelServable is a TransformerServable with the extra API to set model data for Pai.
 *
...
public interface PaiModelServable<T extends PaiModelServable<T>> {
    ...
    T setModelData(List<Row> modelRows) throws IOException;

    /** Gets result schema information. */
    Tuple2<String[], DataType[]> getResultNamesAndTypes();

    /** Sets designer parameters to Flink-ML servable algorithm. */
    void setDesignerParams(Map<String, Object> mapParams);
}
